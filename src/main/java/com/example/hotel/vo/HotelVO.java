...
public class HotelVO {
    ...
    public void setRateNumbers(Integer rateNumbers) {
        this.rateNumbers = rateNumbers;
    }

    public Integer getRateNumbers() {
        return rateNumbers;
    }
    ...
    public void setHotelServiece(List<String> hotelService) {
