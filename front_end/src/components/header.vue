    ...
    <div class="header">
        ...
        <a-menu v-model="current" mode="horizontal" theme="light">
            <a-menu-item key="1" @click="selectMenu">
                <!--只有client用户的首页才跳转到酒店列表-->
                <router-link to="/hotel/hotelList" v-if="userInfo.userType=='Client'">
                    <a-icon type="home" />首页
                </router-link>
                <router-link to="/admin/welcome" v-if="userInfo.userType!='Client'">
                    <a-icon type="home" />首页
                </router-link>
            </a-menu-item>
