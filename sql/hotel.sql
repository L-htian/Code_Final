...
INSERT INTO `Coupon` VALUES (2,'满500-100优惠',2,3,'满减优惠券',500,0,1,NULL,NULL,100,NULL),
                            (3,'满1500000-5优惠',2,3,'满减优惠券',1500000,0,1,NULL,NULL,5,NULL),
                            (4,'满2间打9折优惠',2,2,'间数优惠券',NULL,0.9,1,NULL,NULL,0,2),
                            (5,'满200-20优惠',-1,3,'满减优惠券',200,0,1,NULL,NULL,20,NULL),
                            (7,'满3间打85折优惠',-1,2,'间数优惠券',NULL,0.85,1,NULL,NULL,0,3),
                            (8,'超级无敌至尊VIP客户生日减一块钱优惠',-1,1,'生日优惠券',NULL,NULL,1,NULL,NULL,1,NULL);
...
CREATE TABLE `Hotel` (
  ...
  `rateNumbers` DECIMAL(65,0) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `OrderList` (
  ...
  `annulDate` varchar(222) DEFAULT NULL,
  `isRating` varchar(255) DEFAULT NULL,
  `rate` float(65,1) DEFAULT  NULL,
...
INSERT INTO `User` VALUES (4,'1012681@qq.com','123456','测试一号','12345678919',100,'Client',true,'1992-02-29'),
                          (5,'123@qq.com','123456','测试二号','12345678911',100,'Client',false,NULL),
                          (6,'333@qq.com','123456',NULL,NULL,NULL,'HotelManager',false,NULL),
                          (7,'222@qq.com','123456',NULL,NULL,NULL,'Admin',false,NULL);
